package com.alimoradi.server.main

import com.alimoradi.file_api_online.FileOnlineAuthentication
import com.alimoradi.file_api_online.FileOnlineModule
import com.alimoradi.server.authorization.AuthorizationModule
import com.alimoradi.server.event.EventModule
import com.alimoradi.server.file_handler.FileHandlerModule
import com.alimoradi.server.file_repository.FileRepositoryModule
import com.alimoradi.server.log.LogModule
import com.alimoradi.server.main_argument.MainArgument
import com.alimoradi.server.server.ServerModule
import com.alimoradi.server.shell.ShellModule
import com.alimoradi.server.time.TimeModule
import com.alimoradi.feature_aes.AesModule
